...
EMPLOYEE_MASTER_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "business_unit": ("business_unit", "bu", "business_vertical", "vertical", "division",
                      "lob", "line_of_business", "sbu", "segment"),
    "cost_center": ("cost_center", "cost_centre", "cc", "cost_code", "cost_center_code"),
